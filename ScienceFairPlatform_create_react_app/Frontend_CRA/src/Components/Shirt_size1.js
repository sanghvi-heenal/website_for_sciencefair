...
class shirt_size1 extends React.Component
{
    ...
    _validationErrors(val) {
        const errMsgs = {
          sizeMsg: val.shirt_sizeVal ? '' : 'Choose atleast one option'
        }
        return errMsgs;
    }
    ...
    render()
    {
        return(
            <div>
                ...
                <tr>
                <td align="left">
                <input type="radio" onChange={this.handleCheck.bind(this, 0,'Youth Small- Gold')} 
                       defaultChecked={this.state.shirt_sizes[0].checked}/><font size="3">  
                                   Youth Small- Gold </font>
                </td>
                ...
                <tr><td><font size="3">Indicate t-shirt size for Student(1)</font></td></tr>
                </table>
            </div>
        );
